...
# ---
# Construir un arreglo de sufijos utilizando posiciones de inicio
# ---
def build_suffix_array(text):
    n = len(text)
    # Inicializa el arreglo de sufijos con las posiciones de inicio de cada sufijo
    suffix_array = list(range(n))
    # Ordena las posiciones de inicio basándose en los sufijos implícitos que comienzan en esas posiciones
